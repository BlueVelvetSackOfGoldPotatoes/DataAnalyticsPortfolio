import nltk
import nlp.simpleIntegratedNLPMenu.saveHandler
import nlp.simpleIntegratedNLPMenu.interface
...
def main():
    ...
    print (
        "Automated debugging exercise...\n" +
        "From sample: ", sample + "\n" +
        "A) Print sentence tokenization... \nB) Print word tokenization...\n" +
        "A \n" +
    ...
    '''
    interface.init()
    # NOTE that interface.init() is to handle the dialogue with the user. This will return a list of answers from the user. These answers are to be sent to saveHandler.
